...
val KMeans_Model = KMeans.train(VT_sample_pca_rddvector,kmeans_cluster_number,30,1)
...
val VT_sample_label_rdd = VT_sample_pca_label_with_sha_rdd.map(x=>new VT_sample_label_rdd_class(x._1, OnehotEncode(x._2._3.toDouble)))
